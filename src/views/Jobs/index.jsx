...
export default () => {
    ...
    const onSubmit = values => {
        ...
        axios.post("http://localhost:5000/Job",data).then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/Jobtype/list`)
            .then(res => {
                ...
                return (
                    <>
                        <div style={{ display: 'flex', justifyContent: 'space-around' }} >
                            ...
                            <i onClick={() => setdisplay(true)} style={{ fontSize: '20px' }} class="las la-edit"></i>
                        </div>
                    </>
                )
            }
                ...
                <div style={{ padding: '20px' }} >
                    {
                        ...
                        >
                            ...
                            >
                                ...
                                <Select name='jobtype'  onChange={(value) => {
      ...
      setjobtypeid(value)
                            ...
                            >
                                <div style={{ display: 'flex' }} >
                                    <Button shape="round" type="primary" htmlType="button" onClick={onSubmit} >
                                        Ajouter
                                    </Button>
