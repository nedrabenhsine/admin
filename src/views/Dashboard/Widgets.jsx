...
export const CounterWidgetCust = (props) => {
    ...
    <Card border="light" className="shadow-sm">
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          <Col
            xl={4}
            className="text-xl-center d-flex align-items-center justify-content-xl-center me-4 mb-3 mb-xl-0"
          >
            <div>
              <Customers />
            </div>
...
export const CounterWidgetRev = (props) => {
  const { icon, iconColor, category, title, period, percentage } = props;
  const percentageIcon = percentage < 0 ? faAngleDown : faAngleUp;
  const percentageColor = percentage < 0 ? "text-danger" : "text-success";
    ...
    <Card border="light" className="shadow-sm">
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          <Col
            xl={4}
            className="text-xl-center d-flex align-items-center justify-content-xl-center mb-3 me-4 mb-xl-0"
          >
            <div>
              <Revenue />
            </div>
...
export const CounterWidgetUsers = (props) => {
  const { icon, iconColor, category, title, period, percentage } = props;
  const percentageIcon = percentage < 0 ? faAngleDown : faAngleUp;
  const percentageColor = percentage < 0 ? "text-danger" : "text-success";
      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          ...
          <Col xs={12} xl={7} className="px-xl-0">
            ...
            <small>
              <FontAwesomeIcon icon={faCalendar} size="xs" /> {period}
            </small>
            <div className="small mt-2">
              <FontAwesomeIcon
                icon={percentageIcon}
        ...
        <Row className="align-items-center">
          <Col className="col-auto">
            <a href="#top" className="user-avatar">
              <Image src={image} className="rounded-circle" size="sm" />
            </a>
          </Col>
          <Col className="ms--2">
